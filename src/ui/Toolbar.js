...
export function initToolbar(container) {
  container.innerHTML = `
    ...
    <div class="toolbar-group toolbar-brand">
      <span class="brand-name">Block<span class="accent">craft</span></span>
      <a class="brand-github" href="https://github.com/Yoyoda/blockcraft" target="_blank" rel="noopener noreferrer" title="View source on GitHub">
